              ...
              <motion.li key={s.step} variants={itemVariants}>
                <article className="group relative flex h-full flex-col overflow-hidden rounded-2xl border border-white/10 bg-white/6 p-5 shadow-[0_24px_80px_-40px_rgba(0,0,0,0.55)] backdrop-blur-sm transition-[border-color,box-shadow] duration-300 hover:border-green/35 hover:shadow-[0_16px_44px_-28px_rgba(106,191,46,0.22)] sm:p-6">
                  ...
                  <div className="relative mb-5 flex items-start justify-between gap-3">
                    ...
                    <span className="flex size-12 shrink-0 items-center justify-center rounded-xl border border-white/15 bg-white/8 text-green2 shadow-[0_0_24px_-8px_rgba(131,217,63,0.35)] transition-colors duration-300 group-hover:border-green/40 group-hover:text-green2">
