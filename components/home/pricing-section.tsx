            ...
            return (
              <motion.article
                ...
                className={`relative flex flex-col rounded-2xl border p-6 text-center text-white sm:p-7 ${
                  plan.emphasized
                    ? "border-green/45 shadow-[0_24px_60px_-28px_rgba(133,199,39,0.25)] ring-2 ring-green/30 ring-offset-2 ring-offset-paper lg:scale-[1.02]"
              ...
              >
                {plan.badge && (
                  <div className="mb-4 flex justify-center lg:-mt-1">
                    <span className="rounded-full bg-green px-3 py-1 text-[11px] font-bold uppercase tracking-wide text-white shadow-[0_8px_24px_-12px_rgba(133,199,39,0.55)]">
                      {plan.badge}
                    </span>
                  </div>
                )}
