          ...
          >
            ...
            <div className="relative border-t border-white/10 p-6 sm:p-8">
              ...
              <Link
                ...
                className="mt-6 inline-flex h-12 w-full items-center justify-center rounded-full bg-green px-6 text-sm font-semibold text-white shadow-[0_12px_40px_-16px_rgba(133,199,39,0.5)] transition-colors hover:bg-green2 sm:w-auto sm:min-w-48"
              >
                ...
                <div className={`relative ${SLIDER_VIEWPORT_MIN}`}>
                  <AnimatePresence mode="wait" custom={direction}>
                    ...
                    >
                      <Link
                        href={book.href}
                        className={`featured-slider-card group/card flex h-full w-full flex-row overflow-hidden rounded-xl border border-white/12 bg-white/6 transition-[border-color,box-shadow] hover:border-green/40 hover:shadow-[0_16px_44px_-28px_rgba(133,199,39,0.35)] ${SLIDER_VIEWPORT_MIN}`}
                      >
